...
* OpenResty
    ...
    * [如何完成 bit 操作](openresty/bit_brief.md)
        * [复习二进制补码](openresty/bit_two_complement.md)
        * [复习位运算](openresty/bit_operations_review.md)
        * [LuaJIT 和 Lua BitOp Api](openresty/bit_LuaJIT_BitOp_Api.md)
        * [位运算算法实例](openresty/bit_bitwise_operation_example.md)
